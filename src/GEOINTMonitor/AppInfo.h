...
#define kApplicationName                "GEOINTMonitor"
#define kApplicationVersion             "1.0"
#define kApplicationDescription         "The GEOINT Monitor is a desktop map application visualizing occurred events worldwide."
